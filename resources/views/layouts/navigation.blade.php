        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('admin.keuangan.index')" :active="request()->routeIs('admin.keuangan.*')">
                            {{ __('Bendahara') }}
                        </x-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('admin.koperasi.index')" :active="request()->routeIs('admin.koperasi.*')">
                            {{ __('Koperasi') }}
                        </x-nav-link>
                    </div>
