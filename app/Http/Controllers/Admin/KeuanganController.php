...
$totalSPP = $totalSPPNormal + $totalSPPManual;
    ...
    public function kamar($kamar, Request $request)
    {
        ...
        return view('admin.keuangan.kamar', compact(
            'kamar',
            'santris',
            'keuangans',
            'bayarBulanans',
...
{   
   ...
   Keuangan::create([
    ...
    // private function hitungSaldoSantri($santri_id)
    // {
    //     $keuangans = Keuangan::where('santri_id', $santri_id)->get();

    //     $total_simpan = $keuangans->where('jenis_transaksi', 'simpanan')->sum('jumlah');
    //     $total_ambil = $keuangans->where('jenis_transaksi', 'penarikan')->sum('jumlah');
    //     $total_spp = $keuangans->where('jenis_transaksi', 'bayar_bulanan')->sum('jumlah');
